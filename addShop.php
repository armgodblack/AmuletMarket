...
<br><br><br><br>
    <form>
        <div class="col-md-2 sidenav" style="position: fixed;">
	...
	<form class="form-addShop">
		<div class="form-addShop">
					...
					?>
                        ...
                        <img id="img" name="img" src="" alt="" style="width: 100px; height: 100px; margin-bottom: 20px" align="left"/><br><br>&nbsp;&nbsp;&nbsp;
                        <span style="color:white; "><font size="4">&nbsp;&nbsp;รูปถ่ายหน้าร้าน</font></span>
                        <input type="file" value="" name="Picture_Shop" id="Picture_Shop" /><br><br><br>
