    ...
    <form class="form-addShop">
        <div class="form-addShop">
            <div class="row">
                ...
                <span style="color:white; text-align:center;"><font size="6">Edit Amulet In Shop : </font></span><br><br>
                
                <div class="col-md-2"></div>&nbsp;&nbsp;
                
                <span style="color:white; text-align:center;"><font size="3">รหัสร้าน</font></span>
                <input  name="NameShop" type="text" value="<?=$objResuut['ID_Shop']?>"  name="idA"   readonly/>
                
                <span style="color:white; text-align:center;"><font size="3">ร้าน</font></span>
                <input style="width:260px"  type="text" value="<?=$objResuut['Name_Market']?>"  name="idA"   readonly/>
                
                <span style="color:white; text-align:center;"><font size="3">ID Data</font></span>
                <input  type="text" value="<?=$row_show['ID_amulet']?>"  name="idA"   readonly/><br><br><br>                  
...
?>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่1</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่2</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่3</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่4</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่5</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่6</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่7</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่8</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่9</font></span>
    ...
    <span style="color:white; text-align:center;"><font size="5">ชิ้นที่10</font></span>
