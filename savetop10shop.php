...
if(isset($_POST["submit"])) {
    ...
    $sql = "select * from top10shop where Name_Shop = '".trim($_POST['Name_Shop1'])."' ";
...
$Img_Logo=$_POST['Img_Logo'];
    ...
    $sql = "INSERT INTO top10shop (`Name_Shop`,`Name_Owner`,`MarketAmuletShop`,`Phone`,`Facebook`,`Line`,`Detail_Shop`,`Picture_Shop`,`Img_Logo`,`pd_date`)
...
echo "<script>alert('Save successfully.');</script>";  
 ...
 if(mysql_query($sql)){
              ...
              echo "<script>window.location.replace('managetop10shop.php');</script>";
